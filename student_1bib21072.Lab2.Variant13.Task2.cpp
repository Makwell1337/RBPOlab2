#include <cmath>
#include <iostream>
module student_1bib21072.Lab2.Variant13.Task2;
void RBPO::Lab2::Variant13::Task2::Function1() {
    double x, y;
    std::cout << "Enter x, y >> ";
    std::cin >> x >> y;
...
void RBPO::Lab2::Variant13::Task2::Function2() {
    double x;
    std::cout << "Enter x >> ";
    std::cin >> x;
    double result = 0;
...
void RBPO::Lab2::Variant13::Task2::Function3() {
...
void RBPO::Lab2::Variant13::Task2::Function4() {
